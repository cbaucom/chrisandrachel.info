        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a href="http://google.com" target="_blank" class="dropdown-toggle <disabled>                    </disabled>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <span class="caret"></span></a>
        ...
        if($(window).width() >= 768) {
          ...
          $("a.dropdown-toggle").unbind('click touch');
           ...
           $(".dropdown-menu").hide(); 
                 ...
                 $(this).find('.dropdown-menu').slideDown(600);
