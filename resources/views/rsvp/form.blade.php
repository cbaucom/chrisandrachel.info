...
<div id="testingDiv1" class="clonedInput">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control last_name" name="last_name" placeholder="Baucom" value="{{ old('last_name') }}" >
        </div>                       
    </div>
    <div class="form-group">
        <label for="email" class="col-md-3 col-md-offset-1 control-label email_label">E-Mail</label>
        <div class="col-md-6">
            <input type="email" class="form-control email" name="email" placeholder="chris@example.com" value="{{ old('email') }}">
        </div>
    </div>
    <div class="form-group">
        <label for="restrictions" class="col-md-3 col-md-offset-1 control-label restrictions_label">Dietary Restrictions</label>
        <div class="col-md-6">
            <textarea type="text" class="form-control restrictions" name="restrictions" placeholder="No cheese!" value="{{ old('restrictions') }}"></textarea>
        </div>
    </div>
</div><br>
<div id="add-del-buttons form-group">
